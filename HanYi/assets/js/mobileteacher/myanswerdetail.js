var pagejs = function () {
                ...
                'FileUploaded': function (up, file, info) {
                    ...
                    if (file.type.indexOf("image") >= 0) {
                        if ($('#markWrapPic .showimg').length < 7) {
                            ...
                            html += "<div style=\"width:60px;height:60px;overflow:hidden;\"><img style=\"width:100%;height:auto;\" src=\"" + sourceLink + "\" /></div>";
                            html += "</div>";
    ...
    var handle = function () {
        ...
        //var $a = $("#qaitem");
        //var name = $a.attr("data-name"), classid = $a.attr("data-classid"), id = $a.attr("data-id");
